...
class RiskAssessment(models.Model):
    ...
    offer_anonymity = models.BooleanField(choices=YES_NO_CHOICES,
                                          verbose_name='Do you or your clients offer anonymity to customers?')
    offer_large_value_services = models.BooleanField(choices=YES_NO_CHOICES,
    ...
    offer_services_black_list = models.BooleanField(
        choices=YES_NO_CHOICES, verbose_name='Do you or your clients offer services to any of the following countries? \nNorth Korea, Iran or Myanmar')
    ...
    offer_services_outside_NZ = models.BooleanField(choices=YES_NO_CHOICES,
                                                    verbose_name='Do you or your clients offer services to customers outside New Zealand?')
    cash_intensive = models.BooleanField(choices=YES_NO_CHOICES,
                                         verbose_name="Are yours or any of your client's services cash intensive?")
    company_services = models.BooleanField(choices=YES_NO_CHOICES,
                                           verbose_name='Do you or your clients offer services for registering companies?')
    trust_services = models.BooleanField(choices=YES_NO_CHOICES,
                                         verbose_name='Do you or your clients offer trust services?')
    remittance_services = models.BooleanField(choices=YES_NO_CHOICES,
                                              verbose_name='Do you or your clients offer services for money remittance?')
    virtual_assets_services = models.BooleanField(choices=YES_NO_CHOICES,
